...
class VanillaServer():
    ...
    def setup():
        ...
        print(f"docker run -d {pathToDir} {ports} {minecraft_version} {name} itzg/minecraft-server:{java_version}")
        exec (f"docker run -d {pathToDir} {ports} {minecraft_version} {name} itzg/minecraft-server:{java_version}")
